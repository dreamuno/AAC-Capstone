...
"""
Accrediting Body information on Program Feature

New feature implemented where user can provide more information from accrediting body to specify
specifics they want about the program. This script will make sure that text will be saved from 
form.  
"""
...
def test_add_information():
    ...
    driver.find_element_by_id("id_accreditingBodyPrograms").click()
    driver.find_element_by_id("id_accreditingBodyPrograms").clear()
    driver.find_element_by_id("id_accreditingBodyPrograms").send_keys("test for accredited body information on program")
    driver.find_element_by_xpath("(.//*[normalize-space(text()) and normalize-space(.)='Report Initial Information'])[1]/following::form[1]").click()
    ...
    test = driver.find_element_by_xpath("//input[@name='accreditingBodyPrograms']").text
